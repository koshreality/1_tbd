...
ALTER TABLE [dbo].[department_descriptions]
  ADD CONSTRAINT [FK_department_descriptions_attachment_id] FOREIGN KEY ([attachment_id]) REFERENCES [dbo].[dep_attachments] ([attach_id])
GO